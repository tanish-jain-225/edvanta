...
export function ResumeAnalysis() {
  ...
  // Animate ATS Score gauge from 0 to target score
  useEffect(() => {
    if (analysisResult?.analysis?.score !== undefined) {
      setAnimatedScore(0);
      const timer = setTimeout(() => {
        setAnimatedScore(analysisResult.analysis.score);
      }, 150);
        ...
        {!analysisResult && (
          <div className="flex border-b border-gray-200 mb-8 gap-1">
            <button
              ...
              className={`py-3 px-6 font-semibold text-sm transition-all duration-200 border-b-2 -mb-px flex items-center gap-2 ${activeTab === 'scan'
            ...
            <button
              ...
              className={`py-3 px-6 font-semibold text-sm transition-all duration-200 border-b-2 -mb-px flex items-center gap-2 ${activeTab === 'history'
                  ? 'border-[#289da8] text-[#1b6b73]'
                  : 'border-transparent text-gray-500 hover:text-gray-700'
                }`}
            >
            ...
            {activeTab === 'scan' ? (
              <div className="grid grid-cols-1 gap-8">
                ...
                <div
                  ...
                  onDrop={handleDrop}
                  className={`relative bg-white rounded-2xl border-2 border-dashed p-10 md:p-14 text-center transition-all duration-300 ${!isOnline
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center justify-center text-center">
                ...
                <div className="relative w-36 h-36 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-4xl font-extrabold text-gray-900">{Math.round(animatedScore)}</span>
